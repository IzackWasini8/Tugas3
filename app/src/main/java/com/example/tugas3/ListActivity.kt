...
class ListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        makananList.add(ItemData(R.drawable.chaikwe, "Chai kwe","Kalimantan Barat", "Chai kwe, juga dikenal sebagai choi pan, adalah kue tradisional Tionghoa yang populer di berbagai daerah di Indonesia, terutama di Pontianak. Kue ini memiliki kulit tipis yang terbuat dari tepung beras dan tepung tapioka, dengan berbagai pilihan isian seperti bengkuang, kucai, atau talas. Chai kwe biasanya dikukus dan disajikan dengan sambal cuka atau saus pedas",))
